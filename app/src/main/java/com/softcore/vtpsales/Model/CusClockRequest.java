...
public class CusClockRequest {
    ...
    public CusClockRequest(String date, String employee_Code, String employee_Name, String check_In_Time, String check_In_Remark, String check_out_Time, String check_out_Remark, String check_out_Location, String customer_Code) {
        Date = date;
