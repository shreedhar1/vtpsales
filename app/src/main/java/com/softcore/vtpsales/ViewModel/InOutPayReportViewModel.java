...
public class InOutPayReportViewModel extends MainViewModel {

    MutableLiveData<CommanResorce<List<InOutPayModel>>> _data;

    public InOutPayReportViewModel(@NonNull Application application) {
        super(application);
        _data=new MutableLiveData<>();

    }
    public LiveData<CommanResorce<List<InOutPayModel>>> getInOutDetails(String FromDate, String ToDate, String SlpName, String DbName, String Flag){
