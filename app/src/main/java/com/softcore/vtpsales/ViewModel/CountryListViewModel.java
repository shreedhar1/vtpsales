...
public class CountryListViewModel extends MainViewModel{
    ...
    public LiveData<CommanResorce<List<GeneralModel>>> getCountryList(){
        CommanResorce<List<GeneralModel>> _new_data=new CommanResorce<>();
        _data=new MutableLiveData<>();
        repository.getCountrylist( new Callback<List<GeneralModel>>() {
            @Override
